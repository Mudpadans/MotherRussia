...
function IntermediateWordList() {
    ...
    const categories = [
        { name: 'Travel and Transportation', list: 'travelAndTransportation', subcategories: [
        ...
        { name: 'Shopping and Commerce', list: 'shoppingAndCommerce', subcategories: [
        ...
        { name: 'Health and Medical', list: 'healthAndMedical', subcategories: [
        ...
        { name: 'School and Education', list: 'schoolAndEducation', subcategories: [
        ...
        { name: 'Work and Professions', list: 'workAndProfessions', subcategories: [
        ...
        { name: 'Sports and Leisure', list: 'sportsAndLeisure', subcategories: [
        ...
        { name: 'Nature and Environment', list: 'natureAndEnvironment', subcategories: [
        ...
        { name: 'Technology and Internet', list: 'technologyAndInternet', subcategories: [
        ...
        { name: 'Arts and Entertainment', list: 'artsAndEntertainment', subcategories: [
        ...
        { name: 'Food Preparation and Cooking', list: 'foodPreparationAndCooking', subcategories: [
        ...
        { name: 'Holidays and Celebrations', list: 'holidaysAndCelebrations', subcategories: [
        ...
        { name: 'Emotions and Relationships', list: 'emotionsAndRelationships', subcategories: [
        ...
        { name: 'Law and Government', list: 'lawAndGovernment', subcategories: [
        ...
        { name: 'Real Estate and Housing', list: 'realEstateAndHousing', subcategories: [
        ...
        { name: 'History and Culture', list: 'historyAndCulture', subcategories: [
